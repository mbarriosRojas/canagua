...
$currentModule = $currentModule ?? 'inventario';
...
<head>
    ...
    <title>Reportes - Inventario - <?php echo Config::getAppName(); ?></title>
    ...
    <style>
        ...
        tr.repair-row td { background-color: rgba(0,0,0,.03); }
        tr.repair-row td:first-child { padding-left: 1.5rem; }
        @media print {
            @page { size: landscape; }
            .sidebar, .no-print, .btn, nav, .border-bottom { display: none !important; }
            .main-content { max-width: 100% !important; }
            body { background: white; }
            tr.repair-row td { background-color: #f8f9fa !important; }
        }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom no-print">
                    <h1 class="h2"><i class="fas fa-file-alt me-2"></i>Reportes - Inventario</h1>
                ...
                <form method="POST" class="card mb-4 no-print">
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label for="search" class="form-label">Nombre o código</label>
                                <input type="text" class="form-control" id="search" name="search" value="<?php echo htmlspecialchars($_POST['search'] ?? ''); ?>" placeholder="Buscar por código, nombre, ubicación o marca">
                            </div>
                            <div class="col-md-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3 no-print">
                            ...
                            <form method="get" action="<?php echo BASE_URL; ?>/inventario/reportes-pdf" class="d-inline">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr><td colspan="10" class="text-center text-muted">No se encontraron registros con los filtros indicados.</td></tr>
                                    <?php else: ?>
