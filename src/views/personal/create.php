...
<head>
    ...
    <title>Nuevo Personal - <?php echo Config::getAppName(); ?></title>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <?php $currentModule = 'personal'; $currentSection = 'create'; include __DIR__ . '/../partials/sidebar.php'; ?>
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="fas fa-user-plus me-2"></i>Nuevo Personal</h1>
                    <a href="<?php echo BASE_URL; ?>/personal" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i> Volver</a>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="<?php echo BASE_URL; ?>/personal/create">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="cedula_personal" class="form-label">Cédula *</label>
                                    <input type="text" class="form-control" id="cedula_personal" name="cedula_personal" value="<?php echo htmlspecialchars($data['cedula_personal'] ?? ''); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="cargo" class="form-label">Cargo *</label>
                                    <input type="text" class="form-control" id="cargo" name="cargo" value="<?php echo htmlspecialchars($data['cargo'] ?? ''); ?>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="fecha_ingreso" name="fecha_ingreso" value="<?php echo htmlspecialchars($data['fecha_ingreso'] ?? ''); ?>" required>
                                </div>
                            </div>
                            <hr>
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Crear Personal</button>
