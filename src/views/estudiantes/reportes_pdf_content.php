...
<body>
    <div class="report-header">
        ...
        <p class="report-title">Reporte de estudiantes</p>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr><td colspan="5" style="text-align:center;color:#666;">No se encontraron registros con los filtros indicados.</td></tr>
            <?php endif; ?>
        </tbody>
    </table>
