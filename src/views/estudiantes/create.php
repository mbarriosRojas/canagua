...
<head>
    ...
    <title>Nuevo Estudiante - <?php echo Config::getAppName(); ?></title>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <?php $currentModule = 'estudiantes'; $currentSection = 'create'; include __DIR__ . '/../partials/sidebar.php'; ?>
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="fas fa-user-plus me-2"></i>Nuevo Estudiante</h1>
                    <a href="<?php echo BASE_URL; ?>/estudiantes" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i> Volver</a>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="<?php echo BASE_URL; ?>/estudiantes/create">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="cedula_estudiante" class="form-label">Cédula del Estudiante *</label>
                                    <input type="text" class="form-control" id="cedula_estudiante" name="cedula_estudiante" value="<?php echo htmlspecialchars($data['cedula_estudiante'] ?? ''); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="apellido" name="apellido" value="<?php echo htmlspecialchars($data['apellido'] ?? ''); ?>" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="apellido_2" name="apellido_2" value="<?php echo htmlspecialchars($data['apellido_2'] ?? ''); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="lugar_nacimiento" class="form-label">Lugar de Nacimiento</label>
                                    <input type="text" class="form-control" id="lugar_nacimiento" name="lugar_nacimiento" value="<?php echo htmlspecialchars($data['lugar_nacimiento'] ?? ''); ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="telefono" class="form-label">Teléfono</label>
                                    <input type="text" class="form-control" id="telefono" name="telefono" value="<?php echo htmlspecialchars($data['telefono'] ?? ''); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="cedula_representante" class="form-label">Cédula del Representante</label>
                                    <input type="text" class="form-control" id="cedula_representante" name="cedula_representante" value="<?php echo htmlspecialchars($data['cedula_representante'] ?? ''); ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="instituciones_id_instituciones" name="instituciones_id_instituciones">
                                        ...
                                        <option value="<?php echo (int) $inst['id_instituciones']; ?>" <?php echo (isset($data['instituciones_id_instituciones']) && (int)$data['instituciones_id_instituciones'] === (int)$inst['id_instituciones']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($inst['descripcion'] ?? $inst['cod_institucion'] ?? ''); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Crear Estudiante</button>
