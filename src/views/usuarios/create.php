...
<head>
    ...
    <title>Nuevo Usuario - <?php echo Config::getAppName(); ?></title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="rol" name="rol" required>
                                        ...
                                        <option value="operador" <?php echo ($data['rol'] ?? '') === 'operador' ? 'selected' : ''; ?>>Operador</option>
                                        <option value="supervisor" <?php echo ($data['rol'] ?? '') === 'supervisor' ? 'selected' : ''; ?>>Supervisor</option>
