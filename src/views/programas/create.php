...
<head>
    ...
    <title>Nuevo Programa - <?php echo Config::getAppName(); ?></title>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <?php $currentModule = 'programas'; $currentSection = 'create'; include __DIR__ . '/../partials/sidebar.php'; ?>
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="fas fa-plus me-2"></i>Nuevo Programa</h1>
                    <a href="<?php echo BASE_URL; ?>/programas" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i> Volver</a>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="<?php echo BASE_URL; ?>/programas/create">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="cod_programas" class="form-label">Código del Programa *</label>
                                    <input type="text" class="form-control" id="cod_programas" name="cod_programas" value="<?php echo htmlspecialchars($data['cod_programas'] ?? ''); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="sub_area" class="form-label">Sub Área</label>
                                    <input type="text" class="form-control" id="sub_area" name="sub_area" value="<?php echo htmlspecialchars($data['sub_area'] ?? ''); ?>">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Crear Programa</button>
