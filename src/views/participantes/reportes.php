...
$config = $config ?? [];
$firmantes = $firmantes ?? [];
$reportTitle = 'Reporte de participantes';
$currentModule = $currentModule ?? 'participantes';
...
<head>
    ...
    <title>Reportes - Participantes - <?php echo Config::getAppName(); ?></title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom no-print">
                    <h1 class="h2"><i class="fas fa-file-alt me-2"></i>Reportes - Participantes</h1>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3 no-print">
                            ...
                            <form method="get" action="<?php echo BASE_URL; ?>/participantes/reportes-pdf" class="d-inline">
                            ...
                            <table class="table table-sm table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars(trim(($row['apellido'] ?? '') . ' ' . ($row['nombre'] ?? ''))); ?></td>
