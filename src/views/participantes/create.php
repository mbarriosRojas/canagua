...
<head>
    ...
    <title>Nuevo Participante - <?php echo Config::getAppName(); ?></title>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <?php $currentModule = 'participantes'; $currentSection = 'create'; include __DIR__ . '/../partials/sidebar.php'; ?>
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="fas fa-user-plus me-2"></i>Nuevo Participante</h1>
                        ...
                        <form method="POST" action="<?php echo BASE_URL; ?>/participantes/create">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="cedula_participante" name="cedula_participante" value="<?php echo htmlspecialchars($_POST['cedula_participante'] ?? ''); ?>" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="apellido" class="form-label">Apellido *</label>
                                    <input type="text" class="form-control" id="apellido" name="apellido" value="<?php echo htmlspecialchars($_POST['apellido'] ?? ''); ?>" required>
                                </div>
                                <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" class="form-control" id="correo" name="correo" value="<?php echo htmlspecialchars($_POST['correo'] ?? ''); ?>">
                                </div>
                            </div>
                            <hr>
