...
$currentModule = $currentModule ?? 'cursos';
...
<head>
    ...
    <title>Reportes - Cursos - <?php echo Config::getAppName(); ?></title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom no-print">
                    <h1 class="h2"><i class="fas fa-file-alt me-2"></i>Reportes - Cursos</h1>
                ...
                <form method="POST" class="card mb-4 no-print">
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label for="search" class="form-label">Código o nombre</label>
                                <input type="text" class="form-control" id="search" name="search" value="<?php echo htmlspecialchars($_POST['search'] ?? ''); ?>" placeholder="Buscar por código o nombre del curso">
                            </div>
                            <div class="col-md-4">
                                <label for="cedula_participante" class="form-label">Cédula del participante</label>
                                <input type="number" inputmode="numeric" class="form-control" id="cedula_participante" name="cedula_participante" value="<?php echo htmlspecialchars($_POST['cedula_participante'] ?? ''); ?>" placeholder="12345678" min="0" step="1">
                            </div>
                            <div class="col-md-2">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3 no-print">
                            ...
                            <form method="get" action="<?php echo BASE_URL; ?>/cursos/reportes-pdf" class="d-inline">
                                <input type="hidden" name="search" value="<?php echo htmlspecialchars($_POST['search'] ?? ''); ?>">
                                <input type="hidden" name="cedula_participante" value="<?php echo htmlspecialchars($_POST['cedula_participante'] ?? ''); ?>">
