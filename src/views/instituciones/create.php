...
<head>
    ...
    <title>Nueva Institución - <?php echo Config::getAppName(); ?></title>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <?php $currentModule = 'instituciones'; $currentSection = 'create'; include __DIR__ . '/../partials/sidebar.php'; ?>
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="fas fa-plus me-2"></i>Nueva Institución</h1>
                    <a href="<?php echo BASE_URL; ?>/instituciones" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i> Volver</a>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="<?php echo BASE_URL; ?>/instituciones/create">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="cod_institucion" class="form-label">Código de la Institución *</label>
                                    <input type="text" class="form-control" id="cod_institucion" name="cod_institucion" value="<?php echo htmlspecialchars($data['cod_institucion'] ?? ''); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="telefono_enlace" class="form-label">Teléfono de Enlace</label>
                                    <input type="text" class="form-control" id="telefono_enlace" name="telefono_enlace" value="<?php echo htmlspecialchars($data['telefono_enlace'] ?? ''); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="descripcion" class="form-label">Descripción *</label>
                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="3" required><?php echo htmlspecialchars($data['descripcion'] ?? ''); ?></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="datos_docente_enlace" class="form-label">Datos del Docente Enlace</label>
                                    <textarea class="form-control" id="datos_docente_enlace" name="datos_docente_enlace" rows="2"><?php echo htmlspecialchars($data['datos_docente_enlace'] ?? ''); ?></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input" type="checkbox" id="activo" name="activo" value="1" <?php echo (!isset($data['activo']) || !empty($data['activo'])) ? 'checked' : ''; ?>>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Crear Institución</button>
