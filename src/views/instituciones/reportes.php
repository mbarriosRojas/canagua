...
$config = $config ?? [];
$firmantes = $firmantes ?? [];
$reportTitle = 'Reporte de instituciones';
$currentModule = $currentModule ?? 'instituciones';
...
<head>
    ...
    <title>Reportes - Instituciones - <?php echo Config::getAppName(); ?></title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom no-print">
                    <h1 class="h2"><i class="fas fa-file-alt me-2"></i>Reportes - Instituciones</h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="search" name="search" value="<?php echo htmlspecialchars($_POST['search'] ?? ''); ?>" placeholder="Buscar por nombre o código">
                            </div>
                            <div class="col-md-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3 no-print">
                            ...
                            <form method="get" action="<?php echo BASE_URL; ?>/instituciones/reportes-pdf" class="d-inline">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo htmlspecialchars($row['cod_institucion'] ?? ''); ?></td>
                                        <td><?php echo htmlspecialchars($row['descripcion'] ?? ''); ?></td>
                                        <td><?php echo htmlspecialchars($row['telefono_enlace'] ?? '-'); ?></td>
