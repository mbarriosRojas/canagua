...
<head>
    ...
    <title>Instituciones - <?php echo Config::getAppName(); ?></title>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover" id="institucionesTable">
                            ...
                            render: function(data, type, row) {
                                return `
                                    <div class="btn-group" role="group">
                                        <button type="button" class="btn btn-sm btn-outline-info" onclick="viewEstudiantes(${row.id_instituciones})">
                                            <i class="fas fa-users"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="editInstitucion(${row.id_instituciones})">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-outline-danger" onclick="deleteInstitucion(${row.id_instituciones})">
